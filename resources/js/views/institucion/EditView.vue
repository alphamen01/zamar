<template>
    <div class="air__layout__content">
      <div class="air__utils__content">
          ...
          <div class="col-lg-12">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Editar institución</li>
              </ol>
            </nav>
          </div>
        </div>
        ...
        <h3>
            <span class="mr-3">Editar institución</span>
        </h3>
        </div>
        <div class="card">
          <div class="card-body">
                    ...
                    <form v-if="!loading" @submit.prevent="Update">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-2" id="d-abreviatura" >
                                <label >Abreviatura <div class="obligatorio">*</div></label>
                                <input type="text" tabindex="2" class="form-control focusNext"  v-model='formulario.abreviatura' />
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-9" style="text-align: right;">
                                ...
                                <div style="text-align: right;">
                                    <button type="submit" tabindex="18" class="btn btn-primary mr-2 mb-2" id="save" >Actualizar Institución</button>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            Update:function(){
                ButtonProcessSave();
                axios.put('/institucion/'+ this.$route.params.id ,this.formulario).then(respuesta => {
                        ButtonProcessSave();
        ...
        mounted(){
            this.agente = false;
            this.loading = true;
            axios.get('institucion/'+ this.$route.params.id +'/edit/').then((response)=>{
    ...
    function ButtonProcessSave() {
      ...
      $('#save').html("<img src='zamar/loading.svg'> Actualizar");
    }
