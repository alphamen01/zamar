<template>
  ...
  <div class="air__layout__content">
      <div class="air__utils__content">
          ...
          <div class="col-lg-12">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="javascript:void(0);">Instituto</a></li>
                <li class="breadcrumb-item active" aria-current="page">Relación de instituciones</li>
              </ol>
            </nav>
          </div>
        </div>
        ...
        <h3>
            <span class="mr-3"> Institución</span>
            <router-link to="/createinstitucion">
              <a href="#"  target="_blank" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Nueva Institución</a>
             </router-link>
        ...
        <div class="card">
          <div class="card-body">
            <h4 class="mb-4">
              <strong>Relaciónes de instituciones</strong>
            </h4>
            <div class="row">
              <div class="col-lg-12">
                <div class="mb-5" >
                  ...
                  <table class="table table-hover nowrap" id="datable" >
                    ...
                    <tbody>
                      <tr v-for ="(institucion, numero) in data">
                        <td><center> {{ numero +1  }} </center></td>
                        <td>{{ institucion.nombre_ies }}</td>
                        <td>{{ institucion.telefono }}</td>
                        <td>
                          <router-link :to="{name: 'editinstitucion', params: {id: institucion.id_institucion }}">
                              <span class="badge badge-secondary">Editar</span>
                          </router-link>
                          <span class="badge badge-danger" v-on:click.capture='Delete(institucion.id_institucion,institucion.nombre_ies)' style="cursor: pointer;">Eliminar</span>
                          </td>
                      </tr>
  ...
  export default {
     ...
     methods:{
      ...
      Delete(id,name){
            ...
            function(isConfirm) {
                if (isConfirm) {
                    axios.delete('/institucion/'+id).then(respuesta => {
