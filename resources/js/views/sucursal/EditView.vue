<template>
    <div class="air__layout__content">
      <div class="air__utils__content">
        ...
        <h3>
            <span class="mr-3">Editar sucursal</span>
        </h3>
        </div>
        <div class="card">
          <div class="card-body">
                    ...
                    <form v-if="!loading" @submit.prevent="Update">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-9" style="text-align: right;">
                                <hr>
                                <button type="submit" tabindex="18" class="btn btn-primary mr-2 mb-2" id="save" >Actualizar Sucursal</button>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            Update:function(){
                ButtonProcessSave();
                axios.put('/sucursal/'+ this.$route.params.id ,this.formulario).then(respuesta => {
                        ButtonProcessSave();
        ...
        mounted(){
            this.agente = false;
            this.loading = true;
            axios.get('sucursal/'+ this.$route.params.id +'/edit/').then((response)=>{
    ...
    function ButtonProcessSave() {
      ...
      $('#save').html("<img src='zamar/loading.svg'> Actualizar Sucursal");
    }
    function ButtonNormalSave () {
      $('#save').addClass("btn btn-primary mr-2 mb-2");
      $('#save').attr('disabled', false);
      $('#save').html("Actualizar Sucursal");
    }
